...
restaurant.order(2, 0)  - получается название блюд из массивов starterMenu и mainMenu, которые находятся под индексами 2 и 0.
...
__Если длина масива неизвестна можно присваивать значения переменным через деструктуризацию, которым они будут присвоены по умолчанию__
```
[a=1, b=1, c=1] = [4, 5]
```
